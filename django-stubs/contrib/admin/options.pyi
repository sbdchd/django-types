...
class BaseModelAdmin(Generic[_ModelT]):
    ...
    def get_exclude(self, request: HttpRequest, obj: _ModelT | None = ...) -> Sequence[str]: ...
    def get_fields(self, request: HttpRequest, obj: _ModelT | None = ...) -> Sequence[Callable[..., Any] | str]: ...
    def get_fieldsets(
        self, request: HttpRequest, obj: _ModelT | None = ...
    ) -> list[tuple[str | None, dict[str, Any]]]: ...
    def get_ordering(self, request: HttpRequest) -> list[str] | tuple[Any, ...]: ...
    def get_readonly_fields(self, request: HttpRequest, obj: _ModelT | None = ...) -> list[str] | tuple[Any, ...]: ...
    def get_prepopulated_fields(self, request: HttpRequest, obj: _ModelT | None = ...) -> dict[str, tuple[str]]: ...
    def get_queryset(self, request: HttpRequest) -> QuerySet[_ModelT]: ...
    def get_sortable_by(self, request: HttpRequest) -> list[Callable[..., Any]] | list[str] | tuple[Any, ...]: ...
    def get_inlines(self, request: HttpRequest, obj: _ModelT | None) -> Iterable[type[InlineModelAdmin[Any]]]: ...
...
class ModelAdmin(BaseModelAdmin[_ModelT]):
    ...
    actions: Sequence[Callable[[ModelAdmin[Any], HttpRequest, QuerySet[Any]], HttpResponse | None] | str] | None = ...
    ...
    def get_inline_instances(self, request: HttpRequest, obj: _ModelT | None = ...) -> list[InlineModelAdmin[Any]]: ...
    ...
    def get_object(self, request: HttpRequest, object_id: str, from_field: None = ...) -> _ModelT | None: ...
    def get_changelist_form(self, request: HttpRequest, **kwargs: Any) -> type[ModelForm]: ...
    ...
    def get_action(self, action: Callable[..., Any] | str) -> tuple[Callable[..., Any], str, str]: ...
    ...
    def save_form(self, request: HttpRequest, form: ModelForm, change: bool) -> _ModelT: ...
    def save_model(self, request: HttpRequest, obj: _ModelT, form: ModelForm, change: bool) -> None: ...
    def delete_model(self, request: HttpRequest, obj: _ModelT) -> None: ...
    def delete_queryset(self, request: HttpRequest, queryset: QuerySet[_ModelT]) -> None: ...
    def save_formset(
        self,
        request: HttpRequest,
        form: ModelForm,
    ...
    def response_action(self, request: HttpRequest, queryset: QuerySet[_ModelT]) -> HttpResponseBase | None: ...
    def response_delete(self, request: HttpRequest, obj_display: str, obj_id: int) -> HttpResponse: ...
    def render_delete_form(self, request: HttpRequest, context: Mapping[str, Any]) -> TemplateResponse: ...
...
class InlineModelAdmin(BaseModelAdmin[_ModelT]):
    ...
    def __init__(self, parent_model: type[_ModelT] | _ModelT, admin_site: AdminSite) -> None: ...
    @property
    def media(self) -> Media: ...
    def get_extra(self, request: HttpRequest, obj: _ModelT | None = ..., **kwargs: Any) -> int: ...
    def get_min_num(self, request: HttpRequest, obj: _ModelT | None = ..., **kwargs: Any) -> int | None: ...
    def get_max_num(self, request: HttpRequest, obj: _ModelT | None = ..., **kwargs: Any) -> int | None: ...
    def get_formset(
