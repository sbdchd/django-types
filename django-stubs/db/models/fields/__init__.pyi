...
class IntegerField(Generic[_I], Field[Union[_I, Combinable], _I]):
    ...
    def __new__(  # type: ignore [misc]
        ...
        unique: bool = ...,
        blank: bool = ...,
        null: Union[Literal[False], ExtLiteral[False]] = ...,
        db_index: bool = ...,
    ...
    def __new__(
        ...
        unique: bool = ...,
        blank: bool = ...,
        null: Union[Literal[True], ExtLiteral[True]] = ...,
        db_index: bool = ...,
...
class AutoField(AutoFieldMixin, IntegerField[int], metaclass=AutoFieldMeta):
    def __new__(
        ...
        max_digits: int = ...,
        decimal_places: int = ...,
        primary_key: Union[Literal[True], ExtLiteral[True]] = ...,
        max_length: Optional[int] = ...,
        unique: bool = ...,
        blank: Union[Literal[True], ExtLiteral[True]] = ...,
        null: bool = ...,
        db_index: bool = ...,
