...
# Keep queryset covariance for compatibility with django-stubs. The targeted ty
...
class QuerySet(AltersData, _SupportsContains[object], Iterable[_Row], Sized, Generic[_Model, _Row]):
    ...
    # Keep model and row types related across queryset combinations.
    def __and__(self, other: QuerySet[_Model, _Row]) -> Self: ...  # ty: ignore[invalid-generic-class]
    ...
    def bulk_create(
        self,
        objs: Iterable[_Model],  # ty: ignore[invalid-generic-class]
    ...
    def bulk_update(self, objs: Iterable[_Model], fields: Iterable[str], batch_size: int | None = None) -> int: ...  # ty: ignore[invalid-generic-class]
    ...
    def in_bulk(self, id_list: Iterable[Any] | None = None, *, field_name: str = "pk") -> dict[Any, _Model]: ...  # ty: ignore[invalid-generic-class]
    async def ain_bulk(self, id_list: Iterable[Any] | None = None, *, field_name: str = "pk") -> dict[Any, _Model]: ...  # ty: ignore[invalid-generic-class]
