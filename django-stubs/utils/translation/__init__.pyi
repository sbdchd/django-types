...
def ngettext_lazy(singular: str, plural: str, number: int | str | None = ...) -> StrPromise: ...

ungettext_lazy = ngettext_lazy

def npgettext_lazy(context: str, singular: str, plural: str, number: int | str | None) -> StrPromise: ...
