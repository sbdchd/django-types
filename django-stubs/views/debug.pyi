...
def technical_500_response(request: Any, exc_type: Any, exc_value: Any, tb: Any, status_code: int = ...) -> Any: ...
...
class SafeExceptionReporterFilter(ExceptionReporterFilter):
    ...
    def get_post_parameters(self, request: HttpRequest | None) -> MutableMapping[str, Any]: ...
